...
$elementsArr = [
  ...
  "dob"=>[
	  "errorMessage"=>"<span style='color: red; margin-left: 15px;'>Date of birth cannot be blank and must be a standard date of birth</span>",
    "errorOutput"=>"",
    "type"=>"text",
    "value"=>"12/25/1999",
		"regex"=>"dob"
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      $sql = "INSERT INTO contactMod (name, address, city, state, phone, email, dob, contact, ageRange) VALUES (:name, :address, :city, :state, :phone, :email, :dob, :contact, :ageRange)";
...
$form = <<<HTML
    ...
    <p>Please check contact types you would like (optional):</p>
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" name="ageRange" id="ageRange4" value="50 +"  {$elementsArr['ageRange']['value']['50 +']}>
      <label class="form-check-label" for="ageRange4">50 +</label>
    </div>
